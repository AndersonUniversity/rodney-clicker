...
class ClickersAndUpgradesTest {
    ...
    fun addClickerTest() {
        ...
        assertEquals(105, (rodney.dps * rodney.numOwned * rodney.multiplier) + (helios.dps * helios.numOwned * helios.multiplier) + (eternalFlame.dps * eternalFlame.numOwned * eternalFlame.multiplier) + (koontz.dps * koontz.numOwned * koontz.multiplier) + (joshTandy.dps * joshTandy.numOwned * joshTandy.multiplier))
    }
    ...
    fun addMultiplierTest() {
        ...
        val eternalFlame = ClickersAndUpgrades.AutoClicker(10, 1, 1)
        val koontz = ClickersAndUpgrades.AutoClicker(15, 1, 1)
        val joshTandy = ClickersAndUpgrades.AutoClicker(20, 1, 1)
        ...
        assertEquals(102, (rodney.dps * rodney.numOwned * rodney.multiplier) + (helios.dps * helios.numOwned * helios.multiplier) + (eternalFlame.dps * eternalFlame.numOwned * eternalFlame.multiplier) + (koontz.dps * koontz.numOwned * koontz.multiplier) + (joshTandy.dps * joshTandy.numOwned * joshTandy.multiplier))
    }
}
